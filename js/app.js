...
if (isMobile.any()) {
	const ourSpacesSlider = document.querySelector('.grid__sviper-righr');
	if (ourSpacesSlider) {
		ourSpacesSlider.addEventListener("click", function (e) {
			let item = e.target;
			if (item.closest('.righr-sviper__slide')) {
				item.closest('.righr-sviper__slide').classList.toggle('_active');
			};
		});
	}
...
if (isMobile.any()) {
	const ourSpacesSlider = document.querySelector('.grid__top-sviper');
	if (ourSpacesSlider) {
		ourSpacesSlider.addEventListener("click", function (e) {
			let item = e.target;
			if (item.closest('.top-sviper__slide')) {
				item.closest('.top-sviper__slide').classList.toggle('_active');
			};
		});
	}
	console.log('000');
...
if (isMobile.any()) {
	const ourSpacesSlider = document.querySelector('.grid__sviper-bottom');
	if (ourSpacesSlider) {
		ourSpacesSlider.addEventListener("click", function (e) {
			let item = e.target;
			if (item.closest('.bottom-sviper__slide')) {
				item.closest('.bottom-sviper__slide').classList.toggle('_active');
			};
		});
	}
	console.log('000');
...
let slider_about = new Swiper('.swiper-clients__container', {
	wrapperClass: "swiper-clients__wrapper",
	slideClass: "swiper-clients__slide",
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
//===================================================================
let topSwiper;
topSwiper = new Swiper('.top-sviper__wrapper', {
	observer: true,
	observeParents: true,
	slidesPerView: 2,
	spaceBetween: 30,
	...
	navigation: {
		nextEl: '.control-grid__next',
		prevEl: '.control-grid__prev',
	},
...
let bottomSwiper;
bottomSwiper = new Swiper('.bottom-sviper__wrapper', {
	observer: true,
	observeParents: true,
	slidesPerView: 2,
	spaceBetween: 30,
...
let rightSwiper;
rightSwiper = new Swiper('.righr-sviper__wrapper', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 0,
	speed: 800,
	loop: true,
	slideToСlickedSlide: true,
	pagination: {
		el: '.righr-sviper__dotts',
		clickable: true,
	},
	on: {
		lazyImageReady: function () {
